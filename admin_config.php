...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 pb-20 md:pb-0 md:pl-64 transition-colors">
    ...
    <main class="p-4 md:p-8 max-w-3xl mx-auto">
        <header class="mb-8">
            <h1 class="text-3xl font-extrabold text-slate-800 dark:text-white">Configurações <span class="text-red-500">Globais</span></h1>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div class="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                        ...
                        <p class="font-bold text-slate-800 dark:text-white">v1.3.0</p>
                    </div>
                    <div class="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                        ...
                        <p class="font-bold text-slate-800 dark:text-white"><?= phpversion() ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                ...
                <div class="flex gap-3">
                    <button onclick="if(confirm('Limpar logs com mais de 30 dias?')) cleanLogs()" class="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white px-4 py-2 rounded-lg text-sm font-bold transition shadow-sm">🧹 Limpar Logs Antigos</button>
                </div>
            </div>

            <!-- Links Úteis -->
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                <h3 class="font-bold text-slate-800 dark:text-white mb-4">🔗 Links Rápidos</h3>
                <div class="space-y-2">
