...
# pdo_mysql: conexão com TiDB/MySQL
# gd: manipulação de imagens (compressão de logos/fotos)
RUN apt-get update && apt-get install -y libpng-dev libjpeg-dev libwebp-dev libfreetype-dev \
