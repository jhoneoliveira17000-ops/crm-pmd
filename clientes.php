...
?>
    ...
    <main class="p-4 md:p-8">
        <header class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div class="flex items-center gap-2 md:gap-4">
                <?php include 'header_icons.php'; ?>
                 ...
                 <!-- Notification Bell -->
                 <div class="relative">
                    <button id="notifBtn" class="btn-spring bg-white dark:bg-slate-800 p-2 rounded-full shadow-sm border border-gray-200 dark:border-slate-700 text-slate-400 hover:text-slate-600 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700 transition">
        ...
        <button onclick="openModal('new')" class="btn-spring bg-[var(--theme-color)] hover:brightness-90 text-white px-5 py-2.5 rounded-xl font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition duration-200 flex items-center gap-2">
        ...
        <div class="flex space-x-1 mb-6 bg-white dark:bg-slate-800 p-1.5 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 w-fit">
            <button onclick="filterClients('ativo')" id="tab-ativo" class="btn-spring px-5 py-2 rounded-lg text-sm font-semibold transition bg-green-500/10 text-green-500 shadow-sm ring-1 ring-green-500/50">Ativos</button>
            <button onclick="filterClients('inativo')" id="tab-inativo" class="btn-spring px-5 py-2 rounded-lg text-sm font-medium transition text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700">Inativos</button>
        </div>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto transform scale-95 transition-transform duration-300 border border-gray-200 dark:border-slate-700" id="modalContent">
            ...
            <form id="clientForm" class="p-6 space-y-6">
                ...
                <div class="pt-6 border-t border-gray-200 dark:border-slate-700 flex justify-end gap-3">
                    <button type="button" onclick="closeModal()" class="btn-spring px-5 py-2.5 rounded-lg text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700 font-medium transition">Cancelar</button>
                    <button type="submit" class="btn-spring bg-[var(--theme-color)] hover:brightness-90 text-white px-6 py-2.5 rounded-lg font-bold shadow-lg transition transform hover:-translate-y-0.5" id="btnSave">Salvar Cliente</button>
                </div>
            </form>
        </div>
    </div>
